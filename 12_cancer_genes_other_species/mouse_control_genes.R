...
name_id_file <- paste(base_path, "mmusculus_control_genes.csv", sep="")
...
mouse_control_genes_file <- paste(base_path, "mouse_control_genes.txt", sep="")
write(unique(rlt_nm$ensembl_transcript_id), mouse_control_genes_file)
