...
cdur_file = PurePath(base_path, "cdur.loxodonta_africana_pc_transcripts.tc.csv")
cancer_genes_file = PurePath(base_path, "lafricana_cancer_genes.csv")
control_genes_file = PurePath(base_path, "lafricana_control_genes.csv")
...
output_file = PurePath(base_path, "cdur.loxodonta_africana_pc_transcripts.tc.geneclass.csv")
