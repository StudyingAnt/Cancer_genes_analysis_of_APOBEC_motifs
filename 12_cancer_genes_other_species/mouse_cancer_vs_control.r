...
data_file <- paste(base_path, "cdur.gencode.vM33.pc_transcripts.nopary.cdsonly.refseq.tc.geneclass.csv", sep = "")
...
out_file <- paste(base_path, "mouse_cancer_vs_control.png", sep="")
