...
cdur_file <- paste(base_path, "cdur.gencode.v40.pc_transcripts.nopary.cdsonly.canonical.csv", sep = "")
...
out_file <- paste(base_path, "cdur_plot_canonical_transcripts.tiff", sep="")
ggsave(out_file, plot = cdur_plot, dpi = 600, width = 100, height = 100, device='tiff', units = "mm")
